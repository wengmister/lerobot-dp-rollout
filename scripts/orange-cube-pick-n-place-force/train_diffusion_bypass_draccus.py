...
def main():
    ...
    dataset_config = DatasetConfig(
        repo_id="/home/zkweng/lerobot/datasets/orange_cube_pnp_with_force"
    )
    ...
    policy_config = DiffusionConfig(
        ...
        use_group_norm=False,  # Can't use GroupNorm with pretrained weights
    ...
    wandb_config = WandBConfig(
        ...
        project="lerobot_diffusion_orange_cube_with_force"
    )
    ...
    config = TrainPipelineConfig(
        ...
        output_dir=Path("./outputs/policy/diffusion_orange_cube_with_force"),
