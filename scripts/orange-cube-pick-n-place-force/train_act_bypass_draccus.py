...
def main():
    ...
    dataset_config = DatasetConfig(
        repo_id="/home/zkweng/lerobot/datasets/orange_cube_pnp_with_force"  # Absolute local path
    )
    ...
    wandb_config = WandBConfig(
        enable=True,
        project="lerobot_act_orange_cube_bypass_force"
    )
    ...
    config = TrainPipelineConfig(
        ...
        output_dir=Path("./outputs/policy/act_policy_orange_cube_bypass_with_force"),
        job_name="act_orange_cube_bypass_force",
        batch_size=16,
        steps=200000,  # Start with fewer steps for testing
        eval_freq=2000,
        save_freq=2000,
        wandb=wandb_config
    )
    ...
    print(f"Policy: ACT with vision and force")
