...
class XHandInterface:
    ...
    def read_state(self, fingure_id=2, force_update=True):
        ...
        print(f"=@= finger.id = {finger_1.id}, finger.position = {finger_1.position * 180 / math.pi} deg")
        print(f"=@= finger.id = {finger_1.id}, finger.torque = {finger_1.torque} mNm")
    ...
    def read_all_joint_states(self):
        print("//================================")
        print("//Read all joint states")
        print("//================================")
        _, state = self._device.read_state(self._hand_id, True)
        for i in range(12):
            finger_i = state.finger_state[i]
            print(f"=@= finger.id = {finger_i.id}, finger.angle = {finger_i.position * 180 / math.pi} deg")
            print(f"=@= finger.id = {finger_i.id}, finger.torque = {finger_i.torque} mNm")
...
if __name__ == "__main__":
    ...
    xhand_exam.read_all_joint_states()
